    ...
    <div>
          ...
          <ul>
            ...
            <li>
              <div>
                ...
                <a
                  className="nav-item reset-filter"
      ...
      {!recipes.length ? (
        ...
        <Cards
          recipes={recipes}
          paginado={paginado}
          deleteDb={deleteRecipeDb}
        />
      )}

      <div className="paginate_home">
        {currentPage === 1 ? (
          <a className="boton_home boton_paginate">Prev</a>
        ) : (
          <a className="boton_paginate" onClick={prevPage}>
            Prev
          </a>
        )}
        <Paginado
        ...
        {indexMax === currentPage ? (
          <a className="boton_home boton_paginate">Next</a>
        ) : (
          <a className="boton_paginate" onClick={nextPage}>
            Next
          </a>
        )}
      </div>
